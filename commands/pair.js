...
module.exports = {
    pattern: "pair",
    desc: "Connect your WhatsApp to RAMA-XMD for enhanced features",
    react: "💓",
    category: "utility",
    filename: __filename,
    ...
    execute: async (conn, mek, m, { from, args, q, reply }) => {
        ...
        try {
            ...
            const pairingMessage = `🔑 *RAMA-XMD Pairing Instructions* 🔑\n\n` +
                                `🌐 *Pairing Link:* https://RAMA-XMD-.onrender.com\n\n` +
                                `📋 *How to connect:*\n` +
